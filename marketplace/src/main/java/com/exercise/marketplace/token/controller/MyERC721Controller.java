...
public class MyERC721Controller {
    ...
    // 잔고 수량 조회
    @PostMapping("/balance")
    public int balance(@RequestBody MyERC721Request request) throws Exception {
    ...
    public List<String> printTokensOwner(@RequestBody MyERC721Request request) throws Exception {
